...
def help(message):
    ...
    "➕ /add_income [сумма] [категория] — Добавить доход с указанием суммы и категории.\n"
    "➖ /add_expense [сумма] [категория] — Добавить расход с указанием суммы и категории.\n\n"
    "<b>Цели и анализ:</b>\n"
    "🎯 /set_goal [сумма] [описание] — Установить финансовую цель.\n"
    "📊 /statistics — Просмотр статистики по доходам, расходам и прогрессу целей.\n"
    "📜 /view_transactions [период] — История транзакций за указанный период.\n\n"
